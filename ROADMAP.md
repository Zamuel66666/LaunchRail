...
Exit evidence for the adapter boundary: [GitHub Actions run 34769727393](https://github.com/Zamuel66666/LaunchRail/actions/runs/34769727393). Worker restart restoration now reads running runtime metadata; route ownership still needs a dedicated persisted route record and cross-organization API coverage.
